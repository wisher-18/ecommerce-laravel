                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input  wire:model='first_name' class="@error('first_name')border-red-500 @enderror w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none"
                            ...
                            <div>
                                ...
                                <input wire:model='last_name' class="@error('last_name')border-red-500 @enderror w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none" id="last_name" type="text">
                                </input>
                                @error('last_name')
                                <div class="text-sm text-red-500">{{$message}}</div>
                                @enderror
                        ...
                        <div class="mt-4">
                            ...
                            <input wire:model='phone' class="@error('phone')border-red-500 @enderror w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none" id="phone" type="text">
                            </input>
                            @error('phone')
                                <div class="text-sm text-red-500">{{$message}}</div>
                                @enderror
                        ...
                        <div class="mt-4">
                            ...
                            <input wire:model='street_address' class="@error('street_address')border-red-500 @enderror w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none" id="address" type="text">
                            </input>
                        ...
                        <div class="mt-4">
                            ...
                            <input wire:model='city' class="@error('city')border-red-500 @enderror w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none" id="city" type="text">
                            </input>
                            @error('city')
                                <div class="text-sm text-red-500">{{$message}}</div>
                                @enderror
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input wire:model='state' class="@error('state')border-red-500 @enderror w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none" id="state" type="text">
                                </input>
                                @error('state')
                                <div class="text-sm text-red-500">{{$message}}</div>
                                @enderror
                            ...
                            <div>
                                ...
                                <input wire:model='zip_code' class="@error('zip_code')border-red-500 @enderror w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none" id="zip" type="text">
                                </input>
                                @error('zip_code')
                                <div class="text-sm text-red-500">{{$message}}</div>
                                @enderror
