              ...
              <tbody>
                ...
                @php
                    ...
                    if($order->status == 'new'){
                        ...
                        $status = '<span class="px-3 py-1 text-white bg-red-500 rounded shadow">Canceled</span>';
                    }
                ...
                <tr wire:key='{{$order->id}}' class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-900 dark:even:bg-slate-800">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">{{Number::currency($order->grand_total, 'INR')}}</td>
